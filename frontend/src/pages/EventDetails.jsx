...
export default function EventDetails() {
    ...
    if (!event) return <div
        className="min-h-screen bg-gray-900 flex items-center justify-center text-white">Ładowanie...</div>;
        ...
        <div className="min-h-screen bg-gray-900 text-white font-sans p-6">
            ...
            <div className="max-w-4xl mx-auto flex items-center justify-between mb-8">
                ...
                <div className="flex gap-3">
                    ...
                    <button
                        ...
                        className="bg-green-600 hover:bg-green-500 px-4 py-2 rounded-lg font-bold shadow-lg transition-all flex items-center gap-2"
                    >
                        💸 Finanse
                    </button>
                </div>
            ...
            <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="md:col-span-2 bg-gray-800 rounded-2xl p-8 border border-gray-700 shadow-xl">
                    ...
                    <div
                        className="text-xs text-gray-500">Utworzono: {new Date(event.created_at).toLocaleDateString()}</div>
                </div>
                        ...
                        <form onSubmit={handleInvite}>
                            ...
                            <div className="flex gap-2">
                                <button type="button" onClick={() => setIsInviteOpen(false)}
                                        className="flex-1 py-2 bg-gray-700 rounded-lg">Anuluj
                                </button>
                                <button type="submit" className="flex-1 py-2 bg-blue-600 rounded-lg font-bold">Wyślij
                                </button>
                            </div>
                        </form>
                    </div>
            ...
            {isChatOpen && (
                <div
                    className="fixed bottom-6 right-6 w-full max-w-md h-[500px] bg-gray-800 border border-gray-600 rounded-2xl shadow-2xl flex flex-col z-40 overflow-hidden animate-in slide-in-from-bottom-5">
                    ...
                    <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-gray-900/50">
                        {messages.map((msg) => (
                            <div key={msg.id} className="group">
                                ...
                                <div
                                    className="bg-gray-700 p-3 rounded-2xl rounded-tl-none border border-gray-600 shadow-sm inline-block max-w-full">
